...
- 所有动画统一归一化（鲸鱼高 280px、520×340 画布），显示大小一致且高清
- **自动动作频率**：每次 idle（间隔 4-10s）加权随机——walk 42% / dance 10% / wave 9% / eat 9% / kick 7% / punish 5% / 继续 idle 18%；一次性动作播放 4-5.5s 后回 idle
- **入睡**：无操作 90s 自动入睡，任何交互（点击/拖动/面板按钮）都会重置计时并唤醒
